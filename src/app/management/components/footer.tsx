...
export default function Footer() {
    ...
    return (
        <div className={`relative z-10 flex ${footerInfo.hasExportDataFooter ? 'justify-between' : 'justify-end'} items-center h-fit mx-2 rounded-md bg-white shadow-md mb-4 text-black`}>
            {
                footerInfo.hasExportDataFooter &&
