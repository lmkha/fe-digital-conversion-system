        ...
        <ul className="ml-6 max-h-screen">
          {permissionList.department.read && (
            <li key={"department"}>
              <Link
                ...
                className={`flex items-center hover:bg-blue-800 py-3 ${
                  activeLink === "department" ? "bg-blue-800" : ""
                }`}
          ...
          <li key={"permission"}>
            <Link
              ...
              className={`flex items-center hover:bg-blue-800 py-3 ${
                activeLink === "permission" ? "bg-blue-800" : ""
              }`}
          ...
          <li key={"report-configuration"}>
            <Link
              ...
              className={`flex items-center hover:bg-blue-800 py-3 ${
                activeLink === "report-configuration" ? "bg-blue-800" : ""
              }`}
