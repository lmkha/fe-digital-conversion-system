    ...
    <>
      <Stack direction={"row"} justifyContent={"space-between"}>
        <Typography fontWeight={"bold"} paddingBottom={2}>
          4. Kết quả phân loại sức khỏe người lao động
        </Typography>
        <Typography
          sx={{
            color: "red",
      ...
      <Stack direction={"column"} spacing={2} paddingBottom={2}>
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("healthType1")}
          isChange2={listChange?.includes("healthType2")}
          isChange3={listChange?.includes("healthType3")}
        ...
        <DoubleTextFieldGroup
          ...
          isChange1={listChange?.includes("healthType4")}
          isChange2={listChange?.includes("healthType5")}
