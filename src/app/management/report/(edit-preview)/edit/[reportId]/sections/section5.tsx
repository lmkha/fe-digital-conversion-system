                ...
                <TripleTextFieldGroup
                    ...
                    onChange={(value) => {
                        ...
                        if (!isPositiveFraction(value.value1)) {
                            setHelpText((prev) => ({ ...prev, row1: { ...prev?.row1, helperText1: 'Nhập phân số không âm' } }));
                        } else {
                            setHelpText((prev) => ({ ...prev, row1: { ...prev?.row1, helperText1: undefined } }));
                        }
                        if (!isPositiveFraction(value.value2)) {
                            setHelpText((prev) => ({ ...prev, row1: { ...prev?.row1, helperText2: 'Nhập phân số không âm' } }));
                        } else {
                            setHelpText((prev) => ({ ...prev, row1: { ...prev?.row1, helperText2: undefined } }));
                        }
                        if (!isPositiveFraction(value.value3)) {
                            setHelpText((prev) => ({ ...prev, row1: { ...prev?.row1, helperText3: 'Nhập phân số không âm' } }));
                        } else {
                ...
                <TripleTextFieldGroup
                    ...
                    onChange={(value) => {
                        ...
                        if (!isNonNegativeNumber(value.value3)) {
                            setHelpText((prev) => ({ ...prev, row3: { ...prev?.row3, helperText3: 'Nhập số thập phân không âm' } }));
                        } else {
