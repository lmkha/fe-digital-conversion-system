    ...
    <>
      ...
      <Stack direction={"column"} spacing={2} paddingBottom={2}>
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("totalAccidents")}
          isChange2={listChange?.includes("numFatalAccidents")}
          isChange3={listChange?.includes("numAccidentWorkers")}
            ...
            if (
              ...
              if (
                ...
                setHelpText((prev) => ({
                  ...
                  row1: {
                    ...prev?.row1,
                    helperText2: "Không được vượt quá tổng số vụ TNLĐ",
                  },
                }));
              } else {
                setHelpText((prev) => ({
        ...
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("numWorkersDie")}
          isChange2={listChange?.includes("totalAccidentCosts")}
          isChange3={listChange?.includes("accidentDaysLost")}
            ...
            if (
              ...
              if (
                ...
                setHelpText((prev) => ({
                  ...
                  row2: {
                    ...prev?.row2,
                    helperText1: "Không được vượt quá số người bị TNLĐ",
                  },
                }));
              } else {
                setHelpText((prev) => ({
