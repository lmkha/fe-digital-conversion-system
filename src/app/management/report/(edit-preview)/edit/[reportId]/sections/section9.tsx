...
import DoubleTextFieldGroup, {
  DoubleTextFieldGroupData,
} from "../components/double-tf-group";
    ...
    <>
      ...
      <Stack direction={"column"} spacing={2} paddingBottom={2}>
        <DoubleTextFieldGroup
          ...
          isChange1={listChange?.includes("observationSamples")}
          isChange2={listChange?.includes("nonStandardSamples")}
        ...
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("nonTemperatureStandardSamples")}
          isChange2={listChange?.includes("nonHumidityStandardSamples")}
          isChange3={listChange?.includes("nonWindStandardSamples")}
        ...
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("nonLightStandardSamples")}
          isChange2={listChange?.includes("nonNoiseStandardSamples")}
          isChange3={listChange?.includes("nonDustStandardSamples")}
        ...
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("nonVibrateStandardSamples")}
          isChange2={listChange?.includes("nonToxicStandardSamples")}
          isChange3={listChange?.includes("nonRadioactiveStandardSamples")}
          ...
          onChange={(value) => {
            ...
            if (!isPositiveFraction(value.value1)) {
              ...
              setHelpText((prev) => ({
                ...prev,
                row4: { ...prev?.row4, helperText1: undefined },
              }));
            }
            if (!isPositiveFraction(value.value2)) {
              setHelpText((prev) => ({
              ...
              setHelpText((prev) => ({
                ...prev,
                row4: { ...prev?.row4, helperText2: undefined },
              }));
            }
            if (!isPositiveFraction(value.value3)) {
              setHelpText((prev) => ({
              ...
              setHelpText((prev) => ({
                ...prev,
                row4: { ...prev?.row4, helperText3: undefined },
              }));
            }
          }}
        />
        <DoubleTextFieldGroup
          ...
          isChange1={listChange?.includes("nonElectricStandardSamples")}
          isChange2={listChange?.includes("nonOtherStandardSamples")}
          ...
          onChange={(value) => {
            ...
            if (!isPositiveFraction(value.value1)) {
              ...
              setHelpText((prev) => ({
                ...prev,
                row5: { ...prev?.row5, helperText1: undefined },
              }));
            }
            if (!isPositiveFraction(value.value2)) {
              setHelpText((prev) => ({
              ...
              setHelpText((prev) => ({
                ...prev,
                row5: { ...prev?.row5, helperText2: undefined },
              }));
            }
          }}
        />
