    ...
    <>
      ...
      <Stack direction={"column"} spacing={2} paddingBottom={2}>
        <TripleTextFieldGroup
          ...
          isChange1={listChange?.includes("totalOccupationalDiseaseCases")}
          isChange2={listChange?.includes("newOccupationalDiseaseCases")}
          isChange3={listChange?.includes("occupationalDiseaseLeaveDays")}
              ...
              if (
                ...
                setHelpText((prev) => ({
                  ...
                  row1: {
                    ...prev?.row1,
                    helperText2:
                      "Không được vượt quá số người bị BNN tới thời điểm BC",
                  },
                }));
              } else {
                setHelpText((prev) => ({
        ...
        <DoubleTextFieldGroup
          ...
          isChange1={listChange?.includes("earlyRetirementDueToDisease")}
          isChange2={listChange?.includes("totalOccupationalDiseaseCosts")}
