...
import { downloadUserTemplate, previewUser } from "@/services/user";
...
const ImportUsersPopup: React.FC<ImportUsersPopupProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    setIsLoading(true);
    const result = await previewUser(selectedFile, deptId);
    ...
    if (!result.success) {
      ...
      router.push("/management/user/import/preview");
    }
  };
