...
import DepartmentFilter, {
  DeptFilterData,
} from "../components/department-filter";
...
export default function Page() {
  ...
  const [showSelectedDataToolbar, setShowSelectedDataToolbar] =
    useState<boolean>();
        ...
        >
          {userList.map((user) => (
            <UserItemComponent
              ...
              checked={
                checkedItems && checkedItems.includes(user.userId)
                  ? true
                  : false
              }
              onChangePassword={(id) => {
